...
export const ScrapbookView = ({
  ...
  return (
    <div
      className="relative min-h-screen overflow-hidden  text-gray-800 pt-24 md:pt-16"
      style={{
    ...
    >
      ...
      <div className="relative z-10 flex h-full flex-col items-center justify-center p-4">
        <div className="bg-gradient-to-r from-pink-400 to-yellow-300 px-4 py-4 m rounded-lg shadow-lg">
